...
@CucumberOptions(
        ...
        glue = {"hooks", "steps"},
        tags = "@BottomStickyPanel_Var3 or @CategoryPage_Grid_Var3 or @CategoryPage_ListWithoutOptions_Var2 or @ProductPage_Var2",
        ...
        //@ProductPage_Var1 or @ProductPage_Var2 or @ProductPage_Var3
