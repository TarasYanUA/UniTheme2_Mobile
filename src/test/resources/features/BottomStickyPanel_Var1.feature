...
Feature: Проверка отображения Нижней липкой панели - Вариант 1
  ...
  Scenario Outline: Открываем окна в Нижней липкой панели, Выполняем проверки и Делаем скриншоты
    ...
    And Нажимаем кнопку "<Button_04>" в Нижней липкой панели
    Then Делаем скриншот "<Screen_04>"
    And Закрываем "<Button_04>" в Нижней липкой панели
    And Нажимаем кнопку "<Button_05>" в Нижней липкой панели
    Then Делаем скриншот "<Screen_05>"
    And Закрываем "<Button_05>" в Нижней липкой панели
