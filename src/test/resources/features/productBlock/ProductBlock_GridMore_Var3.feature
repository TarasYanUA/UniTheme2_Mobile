@ProductBlock_GridMore_Var3

Feature: Проверка отображения блока товаров "AB: Сетка с кнопкой "Показать ещё" - Вариант 3
  ...
  Scenario: Работаем с витриной и выполняем проверки
    ...
    And Выполняем проверки в блоке:
      | Количество колонок в списке | 6 |
    And Нажимаем кнопку 'Показать ещё' в блоке товаров и делаем скриншоты "ProductBlock_GridMore_Var3__"
    And Выполняем проверки в блоке:
      | Отображать пустые звёзды рейтинга товара        | y                      |
      | Отображать общее значение рейтинга товара       | n                      |
      | Отображать кнопку "Добавить в избранное"        | y                      |
    ...
    And Скроллимся к блоку "товаров"
    And Раскрываем вкладку "Распродажа" у блока
    And Нажимаем кнопку 'Показать ещё' в блоке товаров и делаем скриншоты "ProductBlock_GridMore_Var3 (RTL)__"