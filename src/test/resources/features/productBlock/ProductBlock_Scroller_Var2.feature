  ...
  Feature: Проверка отображения блока товаров "Скроллер" - Вариант 2
    ...
    Scenario: Работаем с настройками темы
      ...
      And Устанавливаем настройки темы:
        ...
        | Скроллер, Количество строк в названии товара                | 2                       |
        | Скроллер, Отображать статус наличия                         | y                       |
        | Скроллер, Отображать модификатор количества                 | n                       |
        | Скроллер, Отображать кнопку "Купить"                        | Только Иконка корзины   |
    ...
    Scenario: Работаем с витриной и выполняем проверки
      ...
      Then Делаем скриншот "ProductBlock_Scroller_Var2"
      ...
      And Раскрываем вкладку "Распродажа" у блока
      And Скроллимся вниз по странице на 200 px
      Then Делаем скриншот "ProductBlock_Scroller_Var2 (RTL)"
